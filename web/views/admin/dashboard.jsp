...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <!-- System Activities Chart -->
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title"><i class="fa fa-line-chart"></i> Hoạt động hệ thống theo thời gian</h3>
                        </div>
                        <div class="box-body">
                            <canvas id="systemActivityChart" width="800" height="300"></canvas>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-info">
                        <div class="box-header with-border">
                            <h3 class="box-title">Thống kê hiệu suất hệ thống</h3>
                            <div class="box-tools pull-right">
                                <button type="button" class="btn btn-box-tool" data-widget="collapse">
                                    <i class="fa fa-minus"></i>
                                </button>
                            ...
                            <div class="row">
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text">Thời gian hoạt động</span>
                                            <span class="info-box-number">${systemUptime}</span>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="info-box">
                                        ...
                                        <div class="info-box-content">
                                            <span class="info-box-text">Thời gian phản hồi</span>
                                            <span class="info-box-number">${avgResponseTime}</span>
                                        </div>
                                    </div>
                                </div>
