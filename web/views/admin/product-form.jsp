    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div style="display:none;">
                ...
                Suppliers: ${not empty suppliers ? suppliers.size() : 0}
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-primary">
                        ...
                        <form action="${pageContext.request.contextPath}/admin/products/${product != null ? 'update' : 'create'}" 
                              method="post" 
                            ...
                            <div class="box-body">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <!-- Supplier -->
                                        <div class="form-group">
                                            <label for="supplierId" class="required">Nhà cung cấp</label>
                                            <select class="form-control" id="supplierId" name="supplierId" required>
                                                <option value="">-- Chọn nhà cung cấp --</option>
                                                <c:forEach var="supplier" items="${suppliers}">
                                                    <option value="${supplier[0]}" 
                                                            ${product != null && product.supplierID == supplier[0] ? 'selected' : ''}>
                                                        ${supplier[1]}
                                                    </option>
                                                </c:forEach>
                                            </select>
