...
<head>
    ...
    <title>Danh Sách Shop - HR | Coffee Shop</title>
    ...
    <div class="wrapper">
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    <li><a href="${pageContext.request.contextPath}/hr/dashboard"><i class="fa fa-dashboard"></i> Trang chủ</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-md-offset-3">
                            <div class="box box-warning">
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/hr/shop">
                                    <div class="box-body">
                        ...
                        <div class="col-xs-12">
                            <div class="box box-success">
                                <div class="box-header with-border">
                                    ...
                                    <div class="box-tools">
                                        <a href="${pageContext.request.contextPath}/hr/shop?action=details" 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center">
                                                                    <button class="btn btn-info btn-sm" 
                                                                            onclick="showShopToken('${shop.apiToken}')">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="callout callout-info">
                        <p>Sử dụng token này để xem chi tiết shop cụ thể.</p>
                    </div>
                    <div class="form-group">
                        <label>API Token:</label>
                        <div class="input-group">
                            <input type="text" class="form-control" id="modalTokenInput" readonly>
                            <span class="input-group-btn">
                                <button class="btn btn-default" type="button" onclick="copyModalToken()">
