                        ...
                        <div class="box-body">
                            <c:if test="${order.statusName != 'Completed' && order.statusName != 'Cancelled'}">
                                ...
                                <c:if test="${not empty nextStatusName}">
                                    <form method="post" action="${pageContext.request.contextPath}/barista/orders?action=updateStatus">
...
<div class="modal fade" id="cancelOrderModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form method="post" action="${pageContext.request.contextPath}/barista/orders?action=cancel">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="cancellationReason">Lý do hủy đơn: <span class="text-danger">*</span></label>
                        <textarea class="form-control" id="cancellationReason" name="cancellationReason" 
                                  rows="4" required placeholder="Vui lòng nhập lý do hủy đơn hàng..."></textarea>
                        <span class="help-block">Lý do hủy đơn sẽ được lưu lại để tham khảo.</span>
                    </div>
