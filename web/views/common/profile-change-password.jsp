...
$(document).ready(function() {
    ...
    $('#newPassword').on('input', function() {
        ...
        if (password.length === 0) {
            strengthElement.html('');
            return;
        }
        
        if (strength.score < 2) {
            strengthElement.html('<span class="strength-weak">Yếu: ' + strength.feedback + '</span>');
        } else if (strength.score < 4) {
            strengthElement.html('<span class="strength-medium">Trung bình: ' + strength.feedback + '</span>');
        } else {
            strengthElement.html('<span class="strength-strong">Mạnh: Mật khẩu tốt!</span>');
        }
    });
    ...
    $('#confirmPassword').on('input', function() {
        ...
        var matchElement = $('#passwordMatch');
        ...
        if (newPassword === confirmPassword) {
            matchElement.html('<span style="color: green;"><i class="fa fa-check"></i> Mật khẩu khớp</span>');
        } else {
            matchElement.html('<span style="color: red;"><i class="fa fa-times"></i> Mật khẩu không khớp</span>');
        }
    });
