...
import services.IssueService.IssueResult;
...
public class IssueController extends HttpServlet {
    ...
    private void showIssueList(HttpServletRequest request, HttpServletResponse response)
        ...
        // Get issues
        IssueResult result = issueService.getAllIssues(page, pageSize, statusFilter, ingredientFilter, null);
        ...
        // Forward to JSP
        request.getRequestDispatcher("/views/inventory-staff/issue-list.jsp").forward(request, response);
    }
    ...
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/inventory-staff/issue-form.jsp").forward(request, response);
    }
    ...
    private void showEditForm(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            List<Ingredient> ingredients = ingredientService.getAllIngredients(1, 1000, null, null, true);
            List<User> userList = userService.getUsers(1, 1000, null, null); // Get all users for confirmedBy dropdown
    ...
    private void showIssueDetails(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            request.setAttribute("issue", issue);
            request.getRequestDispatcher("/views/inventory-staff/issue-details.jsp").forward(request, response);
