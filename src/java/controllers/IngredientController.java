...
import services.IngredientService.IngredientResult;
...
public class IngredientController extends HttpServlet {
    ...
    private void showIngredientList(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/inventory-staff/ingredient-list.jsp").forward(request, response);
    }
    ...
    private void showCreateForm(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/inventory-staff/ingredient-form.jsp").forward(request, response);
    }
    ...
    private void showIngredientDetails(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (ingredient != null) {
                request.setAttribute("ingredient", ingredient);
                request.getRequestDispatcher("/views/inventory-staff/ingredient-details.jsp").forward(request, response);
            } else {
    ...
    private void showLowStockIngredients(HttpServletRequest request, HttpServletResponse response)
        ...
        request.getRequestDispatcher("/views/inventory-staff/low-stock.jsp").forward(request, response);
    }
