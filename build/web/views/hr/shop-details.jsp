...
<head>
    ...
    <title>Chi Tiết Shop - HR | Coffee Shop</title>
        ...
        <div class="content-wrapper">
            <section class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a href="${pageContext.request.contextPath}/hr/shop?action=list"><i class="fa fa-building"></i> Danh sách Shop</a></li>
                            ...
                            <div class="box box-primary">
                                ...
                                <form method="post" action="${pageContext.request.contextPath}/hr/shop">
                                    ...
                                    <div class="box-footer">
                                        ...
                                        <a href="${pageContext.request.contextPath}/hr/shop?action=list" 
